...
const isCodex = !isCopilot && (
  Boolean(process.env.PLUGIN_DATA) ||
  Boolean(process.env.PONYTAIL_CODEX) ||
  Boolean(process.env.CODEX_HOME)
);
const isQoder = !isCopilot && !isCodex && Boolean(process.env.QODER_SESSION_ID);

let stateDir = getClaudeDir();
if (isCodex) stateDir = process.env.PLUGIN_DATA || process.env.CODEX_HOME || path.join(os.homedir(), '.codex');
